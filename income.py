...
#        canvas.get_tk_widget().grid( row=self.rowNumber, columnspan=5 )
    ...
    def setText(self):
        self.j_pension_text.set("{:,.0f}".format(self.j_pension))
        self.j_personal_text.set("{:,.0f}".format(self.j_personal))
        self.j_taxable_text.set("{:,.0f}".format(self.j_taxable))
        self.j_lbTaxable_text.set("{:,.0f}".format(self.j_lbTaxable))
        self.j_lbTax_text.set("{:,.0f}".format(self.j_lbTax))
        self.j_hbTaxable_text.set("{:,.0f}".format(self.j_hbTaxable))
        self.j_hbTax_text.set("{:,.0f}".format(self.j_hbTax))
        self.j_abTaxable_text.set("{:,.0f}".format(self.j_abTaxable))
        self.j_abTax_text.set("{:,.0f}".format(self.j_abTax))
        self.j_nlbTaxable_text.set("{:,.0f}".format(self.j_nlbTaxable))
        self.j_nlbTax_text.set("{:,.0f}".format(self.j_nlbTax))
        self.j_nhbTaxable_text.set("{:,.0f}".format(self.j_nhbTaxable))
        self.j_nhbTax_text.set("{:,.0f}".format(self.j_nhbTax))
        self.j_slTaxable_text.set("{:,.0f}".format(self.j_slTaxable))
        self.j_slTax_text.set("{:,.0f}".format(self.j_slTax))
        self.j_totalTax_text.set("{:,.0f}".format(self.j_totalTax))
        self.j_year_text.set("{:,.0f}".format(self.j_year))
        self.j_month_text.set("{:,.0f}".format(self.j_month))

        self.m_pension_text.set("{:,.0f}".format(self.m_pension))
        self.m_personal_text.set("{:,.0f}".format(self.m_personal))
        self.m_taxable_text.set("{:,.0f}".format(self.m_taxable))
        self.m_lbTaxable_text.set("{:,.0f}".format(self.m_lbTaxable))
        self.m_lbTax_text.set("{:,.0f}".format(self.m_lbTax))
        self.m_hbTaxable_text.set("{:,.0f}".format(self.m_hbTaxable))
        self.m_hbTax_text.set("{:,.0f}".format(self.m_hbTax))
        self.m_abTaxable_text.set("{:,.0f}".format(self.m_abTaxable))
        self.m_abTax_text.set("{:,.0f}".format(self.m_abTax))
        self.m_nlbTaxable_text.set("{:,.0f}".format(self.m_nlbTaxable))
        self.m_nlbTax_text.set("{:,.0f}".format(self.m_nlbTax))
        self.m_nhbTaxable_text.set("{:,.0f}".format(self.m_nhbTaxable))
        self.m_nhbTax_text.set("{:,.0f}".format(self.m_nhbTax))
        self.m_slTaxable_text.set("{:,.0f}".format(self.m_slTaxable))
        self.m_slTax_text.set("{:,.0f}".format(self.m_slTax))
        self.m_totalTax_text.set("{:,.0f}".format(self.m_totalTax))
        self.m_year_text.set("{:,.0f}".format(self.m_year))
        self.m_month_text.set("{:,.0f}".format(self.m_month))

        self.monthly_total_text.set("{:,.0f}".format(self.monthly_total))
        self.monthly_50_total_text.set("{:,.0f}".format(self.monthly_50_total))
        self.monthly_45_total_text.set("{:,.0f}".format(self.monthly_45_total))
        self.monthly_40_total_text.set("{:,.0f}".format(self.monthly_40_total))
        self.monthly_35_total_text.set("{:,.0f}".format(self.monthly_35_total))
        self.monthly_30_total_text.set("{:,.0f}".format(self.monthly_30_total))
        self.monthly_25_total_text.set("{:,.0f}".format(self.monthly_25_total))
